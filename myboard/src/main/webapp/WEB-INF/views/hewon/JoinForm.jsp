...
<body>
<div class="joinform">
<form id="joinForm"  action="" class="form" method="post">
	<h3 class="mb-5" style="text-align: center; font-size: 10px; font-weight:900; color: #706FFF;">회원가입</h3>
	<label for="id">
		<p>아이디</p>
		<input class="join" type="text" id="id" name="id" placeholder="5~20자 영문자,숫자를 사용해주세요.">
	</label>
	<div class="mb-5">
		<span id="idNullMsg" class="msg idMsg">아이디를 입력해 주세요.</span>
		<span id="idValidMsg" class="msg idMsg">아이디는 영문자로 시작되는 영문자,숫자의 5~20범위의 문자로만 작성 가능합니다.</span>
		<span id="idDuplMsg" style="">${message } </span>
	</div>
	
	<label for="password">
		<p>비밀번호</p>	
		<input class="join" type="password" id="passwd" name="pw" required placeholder="6~20자 영문자, 숫자, 특수문자 사용.">
	</label>
	<div class="mb-5">
	...
	<label for="name">
		<p>이름</p>	
		<input class="join" type="text" id="name" name="name" required placeholder="이름을 입력해 주세요.">
	</label>
	<div class="mb-5">
	...
	<label for="email">
		<p>이메일</p>	
		<input class="join" type="email" id="email" name="email" placeholder="ex) abc123@naver.com">
	</label>
	<div class="mb-5">
	...
	<label for="phone">
		<p>휴대폰 번호</p>	
		<input class="join" type="text" id="phone" name="phone" required placeholder="ex) 01012345678" maxlength="11">
	</label>
	<div class="mb-5">
